...
hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.exec_cmd("systemctl suspend"))
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.dpms({ action = "toggle", monitor = "eDP-1" }))
hl.bind(mainMod .. " + SHIFT + BACKSPACE", function()
